...
let package = Package(
    ...
    targets: [
        // Binary targets with valid module aliases
        .binaryTarget(
            name: "ZXing",
        ...
        .binaryTarget(
            ...
            moduleAliases: ["bctoolboxTester": "bctoolbox_tester_macos"]
        ),
        .binaryTarget(
            name: "bctoolbox",
        ...
        .binaryTarget(
            ...
            moduleAliases: ["belleSip": "belle_sip_macos"]
        ),
        .binaryTarget(
            name: "belr",
        ...
        // Aggregate target for all binary targets
        .target(
